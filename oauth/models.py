...
class OAuthConfig(models.Model):
    ...
    callback_url = models.CharField(max_length=200, verbose_name='Адрес обратного вызова', blank=False, default='http://www.baidu.com')
    is_enable = models.BooleanField('Включен ли', default=True, blank=False, null=False)
    created_time = models.DateTimeField('Время создания', default=now)
    last_mod_time = models.DateTimeField('Время изменения', default=now)
